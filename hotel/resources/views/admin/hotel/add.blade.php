...
<div class="row">
	<div class="col-md-6 mx-auto mt-4">
		...
		<div class="card bg-danger border-danger">
			<div class="card-body">
				<h3 class="card-titel text-white">Add Hotel</h3>
				...
				<form action="{{url('/addhotel')}}" method="post" enctype="multipart/form-data">
				   ...
				   <div class="form-group">
						...
						<input type="number" name="room" id="room" class="form-control mt-2" placeholder="Room">
				   </div>
				   <div class="form-group">
				   	<button class="btn btn-light btn-block mt-4 col-md-4 general"  name="submit">Add Hotel</button>
				   </div>
